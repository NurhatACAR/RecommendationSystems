...
#sütun adlarını veriyoruz(csv dosyası değil).
...
Contact_user_ratings.head()#NaN değerler değerlendirme yapmayan kullanıcılardır.
...
#Sıralama yapıp film önerisine bakalım.
